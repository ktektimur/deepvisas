            ...
            <Card className="border">
              <CardContent className="pt-6">
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <div className="mt-4 w-48 h-6 bg-gray-200 rounded animate-pulse"></div>
                  <div className="mt-2 w-32 h-4 bg-gray-200 rounded animate-pulse"></div>
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">{submission.fullName}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">{submission.placeOfBirth}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">{submission.passportNumber}</p>
                        </div>
                      </div>
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900">{submission.currentAddress}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 capitalize">{submission.purposeOfVisit}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 capitalize">{submission.currentEmployment}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">{submission.monthlyIncome}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">{submission.fundsAvailable}</p>
                      </div>
                    </div>
                  </div>
                </div>
